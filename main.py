...
class Chat(Screen):
    ...
    def send_button(self):
        ...
        if self.ids.namelabel.text  == "good" or  self.ids.namelabel.text == "that's nice" or self.ids.namelabel.text == "cool" or self.ids.namelabel.text == "That's good" or self.ids.namelabel.text == "That's awesome!":
            ...
            if self.predicted_label == "lonely" or self.predicted_label == 'anger' or self.predicted_label == 'sad' or self.predicted_label == 'depressed' or self.predicted_label == 'anxiety':
                self.ids.showcolby.text = "There are some steps you could follow to get out of this state of your mind \n You can listen to some cheerful music \n Watch movies \n Go for a walk \n These options will help you stay out of it. Keep this conversation going I will help you feel happy."
            ...
            if self.predicted_label == "lonely" or self.predicted_label == "anger" or self.predicted_label == 'sad' or self.predicted_label == 'depressed' or predicted_label == 'anxiety':
